"""
anomaly_detector_bjean.py - Project script (example).
...
Paths (relative to repo root)
    ...
    INPUT FILE: data/clinic_data_bjean.csv
    OUTPUT FILE: artifacts/anomalies_bjean.csv

Terminal command to run this file from the root project folder

    uv run python -m cintel.anomaly_detector_bjean
...
DATA_FILE: Final[Path] = DATA_DIR / "clinic_data_bjean.csv"
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "anomalies_bjean.csv"
